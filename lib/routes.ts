...
const ROUTE_OVERRIDES: Record<string, RouteOverride> = {
    ...
    "chennai-to-coimbatore": {
        snippetLede:
            "Chennai to Coimbatore by taxi is approximately 505 km via NH44 (Chennai-Salem) and NH544 (Salem-Coimbatore), taking 7 to 8 hours including a meal halt at Salem. One-way drop taxi fares start at ₹7,070 for a sedan, ₹9,595 for an SUV and ₹11,110 for an Innova Crysta — all-inclusive of six toll plazas, driver bata (₹600 for the 400+ km tier), Tamil Nadu state permit, and 5% GST. Coimbatore is the gateway to Ooty (86 km onward), Valparai, Munnar, and the Kerala border.",
        intro:
            "Coimbatore (Kovai in Tamil) is South India's textile capital and a fast-growing IT hub — the second-largest city in Tamil Nadu and the natural pivot point for travel to the Western Ghats. The 505 km Chennai-Coimbatore corridor is one of South India's busiest long-haul taxi routes, running on <strong>NH44</strong> from Chennai through Vellore, Krishnagiri, and Salem (the geographic midpoint and lunch stop), then turning west on <strong>NH544</strong> through Erode and Tirupur to Coimbatore. Beyond the city itself, Coimbatore is the launchpad for three major onward circuits: <strong>Ooty</strong> (86 km via the Mettupalayam 36-hairpin ghat), <strong>Valparai</strong> (220 km via Pollachi's Aliyar ghat), and the <strong>Kerala border</strong> (Palakkad 55 km, Munnar 165 km). The route is dominated by corporate transfers (textile, engineering, IT companies with offices in Saravanampatti, Peelamedu, and Avinashi Road), tourists heading to the Nilgiris, and pilgrims visiting the Isha Foundation's Adiyogi Shiva statue at Velliangiri Hills.",
        bestTime:
            "<strong>Departure timing:</strong> 4-6 AM for a comfortable 11 AM-1 PM Coimbatore arrival, leaving time for an evening Marudhamalai darshan or onward Ooty drive next day. A 9-10 PM Chennai departure works for a 4-5 AM Coimbatore arrival — popular for corporate Monday-morning starts and pilgrim runs to Isha Foundation. <strong>Best season:</strong> November-February (cool, 22-28°C in both cities). October has retreating-monsoon mood. April-June is hot (35-40°C in Salem belt) but the journey is fully AC-cabin. <strong>Festival peaks:</strong> Pongal (mid-January) creates Tamil Nadu-wide travel surge; Onam (August-September) creates Kerala-direction overflow at Coimbatore. <strong>Avoid:</strong> long-weekend peak Friday afternoon departures from Chennai (Tambaram exit traffic adds 60-90 min).",
        sampleTimeline: [
            { time: "5:00 AM", activity: "Pickup from Chennai (airport, T Nagar, Anna Nagar, Velachery, OMR, Tambaram, or your address)." },
            { time: "6:00 AM (+1 hr)", activity: "Clear Tambaram, join NH44. Highway driving begins. Sriperumbudur (40 km) breakfast halt possible." },
            { time: "8:00 AM (+3 hrs)", activity: "Vellore (140 km) — biryani town and CMC Hospital area. Brief restroom halt." },
            { time: "9:30 AM (+4.5 hrs)", activity: "Krishnagiri (245 km) — NH44/NH48 split point. The route continues straight on NH44 toward Salem." },
            { time: "11:00 AM (+6 hrs)", activity: "Salem (340 km) — major lunch halt. Saravana Bhavan, A2B, or local Kongu Vellala restaurants near the highway. 30-45 minute break. Steel city; gateway to Yercaud hill station." },
            { time: "12:30 PM (+7.5 hrs)", activity: "Erode (440 km) — Kongu textile belt. Brief tea halt." },
            { time: "1:00 PM (+8 hrs)", activity: "Tirupur (480 km) — Indian knitwear capital. Brief halt." },
            { time: "1:30 PM (+8.5 hrs)", activity: "Arrive Coimbatore. Drop at Airport (CJB), Coimbatore Junction, Gandhipuram, RS Puram, Peelamedu IT corridor, Saravanampatti, or your hotel." },
        ],
        dropPoints: [
            "Coimbatore International Airport (CJB)",
            "Coimbatore Junction Railway Station",
            "Gandhipuram (city centre, RS Puram adjacent)",
            "RS Puram (premium residential + retail)",
            "Peelamedu (Avinashi Road, IT corridor — TCS, Cognizant offices)",
            "Saravanampatti (IT park belt — Wipro, Bosch, KGiSL)",
            "Saibaba Colony (residential)",
            "Singanallur (eastern Coimbatore, Singanallur Lake)",
            "Race Course (central, near hospitals)",
            "Coimbatore Medical College / KMCH / GKNM Hospital (medical-tourism drops)",
            "Isha Foundation, Velliangiri Hills (40 km from Coimbatore — Adiyogi Shiva statue, Dhyanalinga)",
            "Marudhamalai Murugan Temple (12 km from city centre, hilltop temple)",
            "Hotels: Vivanta Coimbatore, Le Meridien, Radisson Blu, Hotel Surya International",
        ],
        routeHighlights: [
            { title: "NH44 (Chennai-Krishnagiri-Salem)", detail: "South India's longest north-south highway — passes through Sriperumbudur, Vellore, Krishnagiri to Salem. Four-lane divided, toll-grade quality, heavy commercial traffic 24/7. The Krishnagiri-Salem stretch is the slowest section due to truck volume." },
            { title: "Vellore (140 km)", detail: "Famous for two things — Vellore biryani and CMC Hospital. Many medical-tourism passengers use this route's Vellore exit. The town itself is 4 km off NH44; quick halts use the highway-side dhabas." },
            { title: "Salem (340 km, lunch stop)", detail: "The natural midpoint. Salem is also the gateway to Yercaud hill station (32 km uphill). For Coimbatore-bound passengers, a 30-45 min Salem lunch halt is standard. Saravana Bhavan, A2B, and local Kongu Vellala Gounder hotels (rich gravy-based meals) are the picks." },
            { title: "NH44 → NH544 split at Salem", detail: "Salem is where the highway turns west — NH44 continues south toward Kanyakumari; NH544 (the route to Coimbatore-Kerala) branches off. Coimbatore-bound vehicles take NH544 here through Erode and Tirupur." },
            { title: "Erode and Tirupur (440-480 km)", detail: "The Kongu region's textile cluster. Erode is famous for turmeric markets and handloom; Tirupur is India's knitwear export capital. Brief 15-minute halts at either town's bypass. The road quality from Tirupur to Coimbatore is excellent four-lane." },
            { title: "Six toll plazas (all in your fare)", detail: "Sriperumbudur (Chennai exit), Vellore-Walajapet, Krishnagiri, Salem South, Avinashi (NH544), Coimbatore approach. Combined ~₹700 one-way for a sedan, paid via our corporate FASTag account." },
        ],
        foodStops: [
            { title: "Sriperumbudur (40 km, breakfast)", detail: "A2B, Saravana Bhavan, and McDonald's at the highway bypass — popular first halt for 4-5 AM departures. 20-minute breakfast." },
            { title: "Vellore (140 km, optional)", detail: "Best Vellore biryani at Hotel Saravana Bhavan (highway exit) or Adyar Ananda Bhavan. Quick non-veg pick: Hotel Saravana Bhavan's mutton biryani is a Tamil Nadu institution. 20-30 min halt." },
            { title: "Salem (340 km, lunch — the main halt)", detail: "Saravana Bhavan, A2B, Hotel Annapoorna, and several Kongu-style meals hotels near the Salem highway exit. Local specialty: Salem-style 'thirupur ada' and 'kola urundai'. 30-45 minutes for a proper sit-down lunch." },
            { title: "Coimbatore arrival options", detail: "Annapoorna Gowrishankar (the city's most-loved meals chain), Sree Annapoorna Gandhipuram, Junior Kuppanna for non-veg Kongu specialties (Kongu Chicken Biryani is famous), and Hotel Sangam for South-Indian buffet. Most hotels also have in-house dining." },
        ],
        vehicleGuidance:
            "The 505 km Chennai-Coimbatore route is among our longest single-day drives — 7-8 hours of highway. <strong>Sedans (Etios/Dzire)</strong> at ₹7,070 are the most-booked for 2-3 corporate or family passengers. <strong>Etios</strong> (same rate) gives extra legroom for the long drive. <strong>SUVs (Ertiga/Innova)</strong> at ₹9,595 are the standard family pick for 4-7 passengers, especially when continuing to Ooty via the Mettupalayam ghat. <strong>Innova</strong> at ₹10,100 is preferred for Isha Foundation pilgrim groups (offerings, dhotis, group dining at the ashram). <strong>Innova Crysta</strong> at ₹11,110 is the premium choice for the duration — captain seats in the variant, superior cabin quietness, and better suspension for the slightly bumpier Salem-Erode stretch. <strong>Tempo Travellers</strong> common for corporate textile-industry trade visits and college reunion groups. <strong>For onward Ooty drives:</strong> SUV/Innova/Crysta recommended — the 36 hairpins of Mettupalayam ghat are easier in higher-clearance vehicles. <strong>Diesel preferred</strong> for the long-haul fuel economy.",
        monsoonAdvisory:
            "<strong>Southwest monsoon (June-September):</strong> Coimbatore region gets light-moderate rain due to Western Ghats rain shadow. Salem-Erode stretch occasionally has brief shower episodes — no closures. Coimbatore stays cooler (24-28°C) during these months. <strong>Northeast monsoon (October-December):</strong> primary rain for Chennai side; flooding rare on this corridor since it heads west away from the coast. <strong>March-May (peak summer):</strong> hot inland (35-40°C in Salem-Erode belt); AC essential. Coimbatore stays slightly cooler than Salem due to elevation. <strong>December-February:</strong> ideal — 18-25°C, dry, smooth driving. <strong>Festival surges:</strong> Pongal (mid-January), Onam (August-September), Tamil Nadu Day holidays cause Tambaram exit congestion — depart 30 min earlier or use a 9-10 PM overnight slot.",
        multiDayPackage:
            "For Chennai-Coimbatore combined with Ooty, Valparai, or Kerala destinations, our <strong>multi-day package</strong> uses the same vehicle and driver throughout. Includes daily 250 km kilometre allowance, driver bata (₹600/day for long-haul tier), night halt charges (₹400-600 per night), tolls, GST. <strong>3-day Coimbatore + Ooty:</strong> Day 1 Chennai → Coimbatore. Day 2 Coimbatore → Ooty + sightseeing (Botanical Gardens, Doddabetta, Pykara). Day 3 Ooty → return Chennai (alternative: route via Bangalore). Sedan ~₹16,500, SUV ~₹22,000, Crysta ~₹25,500. <strong>4-day Coimbatore + Munnar (Kerala):</strong> Day 1 Chennai → Coimbatore. Day 2 Coimbatore → Munnar. Day 3 Munnar sightseeing (tea estates, Eravikulam National Park, Echo Point). Day 4 Munnar → return via Coimbatore. Sedan ~₹22,000, Innova ~₹30,000. <strong>2-day Isha Foundation pilgrim package:</strong> Day 1 Chennai → Coimbatore → Velliangiri Hills evening Adiyogi darshan. Day 2 morning Dhyanalinga + return. Sedan ~₹13,500.",
        destinationGuide: [
            { title: "Isha Foundation and Adiyogi Shiva Statue", detail: "40 km from Coimbatore on the foothills of Velliangiri Hills. The 112-foot bronze Adiyogi face (Guinness World Record for largest bust sculpture) is the focal point. Dhyanalinga meditation hall, Linga Bhairavi temple, and the consecrated grounds welcome ~3 million visitors annually. Open 6 AM-8 PM. Free entry. Allow 4-6 hours for the full visit including the optional volunteer-led temple tour. The famous Mahashivratri night (Feb-March) is a major event — book months ahead." },
            { title: "Marudhamalai Murugan Temple", detail: "12 km from Coimbatore city centre — hilltop temple dedicated to Lord Murugan, one of the most-visited Murugan temples in Tamil Nadu. Open 5 AM-12:30 PM and 4 PM-9 PM. Free entry; ₹50 abhishekam tickets. Drive to the foot, then 800m climb or take the cable car (₹20). Allow 2 hours." },
            { title: "Dhyanalinga", detail: "At Isha Foundation — a consecrated meditative space built by Sadhguru Jaggi Vasudev in 1999. The granite Linga is 13'9\" tall, consecrated to embody all seven chakras. Open 6 AM-8 PM. Free entry. Strict silence inside the temple; respectful dress code." },
            { title: "Coimbatore IT corridor (Saravanampatti, Peelamedu)", detail: "Coimbatore's tech hub — home to Wipro, TCS, Cognizant, Bosch, KGiSL, and many startups. The Avinashi Road (Peelamedu) and Saravanampatti belt are the main IT addresses. Corporate transfers from Chennai land here frequently; we run dedicated-driver weekly transfer programmes." },
            { title: "Brookefields Mall and Fun Republic Mall", detail: "Coimbatore's main shopping and entertainment centres. Open 10 AM-11 PM. Free entry; pay for activities/food. Good drop point for evening arrivals." },
            { title: "Annapoorna Gowrishankar and Junior Kuppanna", detail: "The Coimbatore food trail. Annapoorna for breakfast/dosa (legendary; multiple branches; the Gandhipuram outlet is the original). Junior Kuppanna for Kongu Chicken Biryani — Coimbatore's signature non-veg dish. ₹50-300 typical bill." },
            { title: "Kovaipudur viewpoint", detail: "15 km from Coimbatore — small hill viewpoint with cool weather and Coimbatore city panorama. Less crowded than Marudhamalai. Free; allow 60 minutes." },
        ],
        customFaqs: [
            { question: "What is the Chennai to Coimbatore distance?", answer: "Chennai to Coimbatore is approximately 505 km by road via NH44 through Vellore, Krishnagiri, Salem, then NH544 through Erode and Tirupur. The straight-line air distance is shorter (~430 km) but the road follows the highway alignment via the Salem midpoint." },
            { question: "How long does the Chennai to Coimbatore drive take?", answer: "About 7 to 8 hours for the 505 km drive, including a 30-45 minute lunch halt at Salem. Departure timing matters — a 5 AM Chennai exit reaches Coimbatore by 1:30 PM. A 10 PM departure gets you to Coimbatore by 5 AM for early-morning corporate starts or Isha Foundation visits." },
            { question: "How much is a Chennai to Coimbatore taxi fare?", answer: "₹7,070 all-inclusive for a sedan — 505 km × ₹14/km, with six tolls (~₹700 combined), ₹600 driver bata for the 400+ km long-haul tier, Tamil Nadu state permit, and 5% GST baked in. Mini ₹6,565, SUV ₹9,595, Innova ₹10,100, Innova Crysta ₹11,110. Tempo Traveller and Luxury (Mercedes/BMW) on request." },
            { question: "What does 'all-inclusive' mean for this route?", answer: "Your ₹7,070 covers all six toll plazas (Sriperumbudur, Vellore-Walajapet, Krishnagiri, Salem South, Avinashi, Coimbatore approach), the ₹600 driver bata, Tamil Nadu state permit, and 5% GST. Nothing is added at the drop point. Only optional add-ons (Coimbatore Airport entry fee, private property parking, waiting beyond 30-min buffer, additional stops) are billed if used." },
            { question: "Which vehicle is best for this 7-8 hour drive?", answer: "For 2-3 corporate or family passengers, Sedan (₹7,070) is most economical. For 4-7 passengers with luggage, SUV (₹9,595). For elderly travellers, Innova Crysta (₹11,110) — quieter cabin and smoother suspension matter on a 7-hour drive. For 10+ groups (corporate offsites, college reunions), book Tempo Traveller." },
            { question: "Can I continue to Ooty from Coimbatore with the same taxi?", answer: "Yes — book a 2-day combined package. Day 1: Chennai → Coimbatore (₹7,070). Day 2: Coimbatore → Ooty (86 km via Mettupalayam ghat, ₹1,200 sedan). Combined 2-day package ~₹13,500 sedan with driver bata covering both days. Alternative: book Chennai → Coimbatore as a drop, then a separate Coimbatore → Ooty drop the next morning — gives more flexibility but slightly higher total." },
            { question: "Is the route safe at night?", answer: "Yes. NH44 is a major commercial corridor with 24/7 truck traffic, well-lit through Vellore-Krishnagiri-Salem, and has fuel/dhaba availability throughout. NH544 (Salem-Coimbatore) is similarly well-lit and trafficked. Common overnight booking: 9-10 PM Chennai departure for 4-5 AM Coimbatore arrival — popular for Monday-morning corporate starts. Night charges (₹250-500) apply for trips between 10 PM and 6 AM." },
            { question: "Can the taxi drop at Coimbatore Airport (CJB)?", answer: "Yes — CJB airport drop is a common booking pattern. The airport is at Peelamedu, 12 km from Coimbatore Junction. Some Chennai travellers book Chennai → CJB direct to catch international/onward domestic flights from Coimbatore. Same ₹7,070 sedan fare; airport entry fee (~₹50) is the only optional add-on." },
            { question: "How do I get a GST invoice for corporate billing?", answer: "GST is already in your ₹7,070 fare. Share your company name and GSTIN at booking; we email the GST-compliant invoice within 24 hours. Corporate volume bookings (5+ trips/month) qualify for monthly consolidated invoicing with itemised trip details — popular with Saravanampatti and Peelamedu IT-park accounts." },
            { question: "Is one-way taxi cheaper than train + local taxi for Chennai-Coimbatore?", answer: "Depends on group size. For 1-2 passengers, train (Cheran Express, Kovai Express) + local taxi at Coimbatore is cheaper (~₹2,500-3,500 total). For 3+ passengers with luggage, a Chennai-Coimbatore taxi (₹7,070 sedan) is comparable or cheaper than 3 train tickets + local cab, with door-to-door convenience. Corporate travellers prefer the taxi for the productive cabin time (laptop work, calls)." },
        ],
    },
    "hyderabad-to-bangalore": {
        snippetLede:
            "Hyderabad to Bangalore by taxi is approximately 570 km via NH44 through Shadnagar, Kurnool, Anantapur, and Devanahalli, taking 8.5 to 9.5 hours including a meal halt. One-way drop taxi fares start at ₹7,980 for a sedan, ₹10,830 for an SUV and ₹12,540 for an Innova Crysta — all-inclusive of seven toll plazas (~₹650), driver bata (₹600 for the 400+ km tier), two inter-state permits (Telangana → Andhra Pradesh → Karnataka), and 5% GST. This is the most-booked overnight booking corridor for IT and corporate transfers.",
        intro:
            "The Hyderabad-Bangalore corridor connects two of South India's largest tech hubs and is the dominant overnight inter-state taxi route in the region. The 570 km drive runs entirely on <strong>NH44</strong> — the longest National Highway in India — through Shadnagar, Kurnool (210 km, the lunch midpoint), Anantapur (350 km, with the Sai Baba Puttaparthi turnoff 95 km off-route), Penukonda, and the Karnataka entry at Bagepalli, finally approaching Bangalore via Devanahalli and the KIA airport. <strong>Two inter-state crossings</strong> (Telangana → Andhra Pradesh at Jadcherla, Andhra Pradesh → Karnataka at Bagepalli) make this a permit-heavy route — we pre-pay both permits and include them in your quote. Corporate travellers dominate the demand: Monday-morning starts from Hyderabad's HITEC City / Gachibowli to Bangalore's Whitefield / Electronic City / Manyata Tech Park, with Friday return trips. The overnight pattern (9-10 PM Hyderabad departure for 5-6 AM Bangalore arrival) is so common that we run dedicated-driver assignments for weekly transfer accounts.",
        bestTime:
            "<strong>Departure timing:</strong> Two dominant windows. <strong>5-6 AM</strong> for a daytime drive arriving Bangalore by 2-3 PM (popular with families and pilgrims combining Puttaparthi). <strong>9-10 PM</strong> for the overnight slot — drivers do the 8-9 hour drive overnight to deliver passengers at 5-6 AM Bangalore, in time for IT-corridor 9 AM start. <strong>Avoid:</strong> 3-4 AM departures that arrive Bangalore during 8-9 AM peak traffic on Outer Ring Road. <strong>Best season:</strong> November-February (cool, 22-28°C in both cities, dry). October has retreating-monsoon character. March-May (peak summer) the Anantapur belt hits 38-42°C — AC essential. <strong>Festival surges:</strong> Sankranti (mid-January), Bonalu (Hyderabad, July-August), Karnataka Rajyotsava (November 1). Long-weekend Friday departures see 20-30% higher demand; book 5-7 days ahead.",
        sampleTimeline: [
            { time: "9:30 PM (overnight slot)", activity: "Pickup from Hyderabad (Airport, Banjara Hills, Jubilee Hills, HITEC City, Gachibowli, Madhapur, Begumpet, or your address)." },
            { time: "10:30 PM (+1 hr)", activity: "Shadnagar (40 km). Brief 10-minute halt for fuel/restroom." },
            { time: "12:00 AM (+2.5 hrs)", activity: "Jadcherla, then Telangana → Andhra Pradesh state border crossing (permit pre-paid)." },
            { time: "1:30 AM (+4 hrs)", activity: "Kurnool (210 km) — major service halt; A1 Plaza, Saravana Bhavan, or local Andhra-style restaurants. 30-minute dinner/breakfast break." },
            { time: "3:30 AM (+6 hrs)", activity: "Anantapur (350 km). Optional 15-minute halt; Puttaparthi turnoff is here (95 km off-route to Sai Baba ashram for pilgrim circuits)." },
            { time: "4:30 AM (+7 hrs)", activity: "Penukonda (430 km), the AP heritage town. Continue south." },
            { time: "5:00 AM (+7.5 hrs)", activity: "Andhra Pradesh → Karnataka border at Bagepalli (permit pre-paid). Karnataka entry." },
            { time: "5:45 AM (+8.5 hrs)", activity: "Devanahalli — KIA airport approach. If your drop is the airport, journey ends here." },
            { time: "6:30 AM (+9 hrs)", activity: "Arrive Bangalore. Drop at Whitefield, Electronic City, Manyata Tech Park, central CBD, MG Road, Hebbal, Yeshwanthpur, or your hotel." },
        ],
        dropPoints: [
            "Kempegowda International Airport (KIA, Devanahalli) — common direct drop, often quicker than continuing into the city",
            "Bangalore City Railway Station (Majestic / KSR)",
            "Yeshwanthpur Junction",
            "Whitefield (IT corridor — Bagmane Tech Park, ITPL, EPIP Zone)",
            "Electronic City Phase 1 + 2 (Infosys, Wipro HQ)",
            "Manyata Tech Park, Hebbal (north IT corridor)",
            "Marathahalli, Outer Ring Road (central IT corridor)",
            "MG Road / Brigade Road (central CBD)",
            "Koramangala, HSR Layout, Indiranagar (premium residential + startup hubs)",
            "Hospital cluster: Manipal Whitefield, Apollo Bannerghatta, Narayana Hrudayalaya, Fortis Bannerghatta",
            "Hotels: Vivanta Bangalore, Taj West End, Leela Palace, Sheraton Grand, Conrad",
            "Hosur (75 km onward from Bangalore — for combined Hyderabad → Hosur drops)",
        ],
        routeHighlights: [
            { title: "NH44 (Hyderabad-Bangalore corridor)", detail: "Part of India's longest National Highway running Srinagar to Kanyakumari. The 570 km Hyderabad-Bangalore segment is four-lane divided highway throughout, with toll-grade surface quality. Heavy commercial traffic 24/7 keeps the highway lit and serviced overnight." },
            { title: "Kurnool (210 km, midpoint)", detail: "The natural lunch / dinner / breakfast halt depending on your departure time. Famous for Andhra-style biryani and idli; A1 Plaza on NH44 is a 24/7 well-known stop. The town itself was the first capital of independent Andhra Pradesh state (1953-1956). Allow 30-45 min." },
            { title: "Anantapur (350 km)", detail: "The geographic midpoint of the broader corridor, and the home of Sri Sathya Sai Baba's birthplace. The Puttaparthi Sai Baba Ashram is 95 km off NH44 from Anantapur — pilgrim travellers route through here as a side trip. The town itself is in a rain-shadow zone; one of the driest spots between Hyderabad and Bangalore." },
            { title: "Lepakshi heritage detour (490 km off-route)", detail: "13 km off NH44 between Penukonda and Bagepalli — the 16th-century Veerabhadra Temple with the famous hanging pillar that doesn't quite touch the floor, and India's largest monolithic Nandi statue. Worth a 60-90 min cultural halt for slow-paced travellers. Free; allow extra distance billing for the detour." },
            { title: "Andhra Pradesh → Karnataka border (Bagepalli)", detail: "510 km from Hyderabad. Inter-state permit checkpoint. Our corporate FASTag account pre-pays the permit; no driver-side cash transaction. The first major Karnataka town after the border is Chikkaballapur." },
            { title: "Devanahalli + KIA airport", detail: "535 km — Bangalore's primary international airport, 35 km north of central Bangalore. Many Hyderabad → KIA direct bookings exist for international/onward flight connections — same vehicle, just a shorter total drive (~7-8 hrs vs 9 hrs to central Bangalore)." },
            { title: "Seven toll plazas (all in your fare)", detail: "Two Telangana-side, three Andhra Pradesh, two Karnataka. Combined ~₹650 one-way for a sedan, paid via our corporate FASTag account. No driver-side toll handling at any plaza." },
        ],
        foodStops: [
            { title: "Shadnagar (40 km, optional)", detail: "First major Telangana service halt — small dhabas serving Hyderabadi biryani and South Indian meals. Brief 10-15 min halt." },
            { title: "Kurnool (210 km, the main halt)", detail: "The lunch / dinner / breakfast hub of NH44. <strong>A1 Plaza Kurnool</strong> is the 24/7 standard — clean restrooms, multi-cuisine, ATM, fuel. Local picks: Hotel Punnami (RTC Complex), Sandhya Restaurant. Andhra-style meals (chicken biryani, kheema dosa, gongura mutton) are the local specialty. 30-45 min sit-down." },
            { title: "Anantapur (350 km, optional)", detail: "If you've already eaten at Kurnool, this becomes a tea/restroom halt. Anantapur Punnami Hotel and small highway dhabas. The Anantapur belt has limited high-quality options compared to Kurnool — most travellers prefer the Kurnool stop." },
            { title: "Bagepalli / Chikkaballapur (520 km, Karnataka entry)", detail: "First Karnataka stop. Adyar Ananda Bhavan, Kamat Yatri Niwas — South Indian veg meals. 15-min halt for tea before the final approach to Bangalore." },
            { title: "Bangalore arrival options", detail: "Central CBD: MTR, Vidyarthi Bhavan (legendary dosa), Karavalli (Karnataka coastal). Whitefield / Marathahalli ORR: Toit, ITC Gardenia. Electronic City: Brigade Road / Banashankari belt has more options. Many hotels also serve early-morning breakfast for 6 AM arrivals." },
        ],
        vehicleGuidance:
            "The 570 km Hyderabad-Bangalore route is among our longest single-day drives — 8.5-9.5 hours. <strong>Sedans (Etios/Dzire)</strong> at ₹7,980 are most-booked for 2-3 corporate or family passengers. <strong>Etios</strong> (same rate) gives extra legroom and boot space. <strong>SUVs (Ertiga/Innova)</strong> at ₹10,830 are the family pick for 4-7 passengers, especially when adding a Puttaparthi pilgrim detour. <strong>Innova</strong> at ₹11,400 is preferred for pilgrim groups (Sai Baba Ashram visits, Lepakshi heritage trips) and elderly travellers. <strong>Innova Crysta</strong> at ₹12,540 is the premium choice for the duration — captain seats variant, superior cabin quietness, and noticeably smoother suspension on the long stretch. <strong>Tempo Travellers</strong> are common for corporate offsites, IT-park employee bulk transfers, and large pilgrim parties. <strong>For overnight slots:</strong> Crysta or Innova recommended — the smoother ride helps sleep; sedans are fine but feel firmer on the long Anantapur straight. <strong>Diesel preferred</strong> for the long-haul fuel economy.",
        monsoonAdvisory:
            "<strong>Southwest monsoon (June-September):</strong> dominant for both Hyderabad and Bangalore. Telangana side has moderate rains; the Anantapur belt is in a rain shadow and stays drier (often cloudless when Hyderabad has overcast). Bangalore approach can have heavy evening showers. Route operates without closures. <strong>Northeast monsoon (October-December):</strong> Bangalore side gets evening showers; the Andhra-Telangana stretches less affected. <strong>March-May (peak summer):</strong> hot in Anantapur belt (38-42°C); cabin AC essential. Bangalore stays cooler (28-32°C) due to its 920 m elevation. <strong>December-February:</strong> ideal — cool (18-22°C in Bangalore mornings), dry, smooth driving. <strong>Festival surges:</strong> Sankranti (mid-January), Bonalu (Hyderabad festival, July-August), Karnataka Rajyotsava (November 1). Long-weekend Friday departures see 20-30% higher booking volumes; reserve 5-7 days ahead.",
        multiDayPackage:
            "For Hyderabad-Bangalore combined with onward Karnataka destinations, our <strong>multi-day package</strong> uses the same vehicle and driver throughout. Includes daily 250 km kilometre allowance, driver bata (₹600/day for long-haul tier), night halt charges (₹400-600 per night), tolls, multi-state permits, GST. <strong>2-day Hyderabad → Puttaparthi → Bangalore:</strong> Day 1 Hyderabad → Puttaparthi (Sai Baba Ashram, 95 km off NH44 at Anantapur, 8 hrs total) → Bangalore. Sedan ~₹13,000. <strong>3-day Hyderabad → Bangalore → Mysore → return:</strong> Day 1 Hyderabad → Bangalore. Day 2 Bangalore → Mysore sightseeing (Mysore Palace, Chamundi Hill). Day 3 Mysore → return via Bangalore. Sedan ~₹22,000, SUV ~₹29,000. <strong>4-day Hyderabad → Bangalore → Coorg → return:</strong> ~₹26,000 sedan. <strong>Corporate weekly transfer:</strong> Monday Hyderabad → Bangalore IT corridor. Friday Bangalore → Hyderabad return. Dedicated-driver assignment available for accounts with 4+ weekly trips.",
        destinationGuide: [
            { title: "Whitefield IT corridor", detail: "East Bangalore's primary tech hub — Bagmane Tech Park, ITPL, EPIP Zone host most Fortune 500 India offices. Corporate transfers from Hyderabad land here weekly. Drop addresses cluster on Whitefield Main Road, Brookefield, and Kundalahalli." },
            { title: "Electronic City Phase 1 + 2", detail: "South Bangalore — Infosys HQ, Wipro HQ, and 200+ tech companies. 35 km from KIA airport (1.5-2 hrs in traffic). Phase 2 is the newer expansion." },
            { title: "Manyata Tech Park, Hebbal", detail: "North Bangalore IT belt — TCS, Cognizant, IBM, Cisco offices. Close to KIA airport (10 km). Many Hyderabad business travellers prefer hotel near Hebbal for the airport proximity." },
            { title: "Central Bangalore (MG Road, Brigade Road, Koramangala)", detail: "The CBD and legacy hangout zone. UB City Mall, Cubbon Park, Vidhana Soudha state legislature. Koramangala is the startup hub. Allow extra 60-90 min from KIA airport in peak traffic." },
            { title: "Kempegowda International Airport (KIA, Devanahalli)", detail: "35 km north of central Bangalore. Many Hyderabad → KIA direct bookings — saves the 60-90 min city detour for passengers with onward flights. The airport-only drop is ~₹500 less than continuing into the city core." },
            { title: "Cubbon Park and Vidhana Soudha (central)", detail: "Bangalore's central park (300 acres) and the iconic state legislature building. Morning visit best. Open 6 AM-6 PM. Free." },
            { title: "Bangalore Palace and Tipu Sultan's Summer Palace", detail: "Two heritage sites — Bangalore Palace (Tudor Revival, ₹460 entry) and Tipu's Summer Palace (Indo-Islamic, ₹50). Open 10 AM-5:30 PM. Combined 90 min visit." },
            { title: "Hospital cluster (medical tourism)", detail: "Manipal Whitefield, Apollo Bannerghatta, Narayana Hrudayalaya (cardiac), Fortis Bannerghatta — major destination for Hyderabad-side medical tourism. We assign Crysta by default for hospital bookings; wheelchair-accessible vehicle on request." },
        ],
        customFaqs: [
            { question: "What is the Hyderabad to Bangalore distance?", answer: "Hyderabad to Bangalore is approximately 570 km by road via NH44 through Shadnagar, Kurnool, Anantapur, Penukonda, and Devanahalli. The straight-line air distance is shorter (~510 km) but the road follows the NH44 alignment through the Andhra Pradesh interior." },
            { question: "How long does the Hyderabad to Bangalore drive take?", answer: "About 8.5 to 9.5 hours for the 570 km drive, including a 30-45 minute meal halt at Kurnool. Departure timing matters — a 5 AM Hyderabad exit reaches Bangalore by 2-3 PM. The popular overnight slot: 9-10 PM Hyderabad departure for 5-6 AM Bangalore arrival." },
            { question: "How much is a Hyderabad to Bangalore taxi fare?", answer: "₹7,980 all-inclusive for a sedan (Etios/Dzire) — 570 km × ₹14/km, with seven tolls (~₹650 combined), ₹600 driver bata for the 400+ km long-haul tier, two inter-state permits (TS → AP → KA), and 5% GST baked in. Mini ₹7,410, SUV ₹10,830, Innova ₹11,400, Innova Crysta ₹12,540. Tempo Traveller and Luxury (Mercedes/BMW) on request." },
            { question: "Are the two inter-state permits included in the fare?", answer: "Yes. Telangana → Andhra Pradesh and Andhra Pradesh → Karnataka permits are both pre-paid by our corporate FASTag account and included in the quoted fare. No driver-side cash transaction at either border. This is a key differentiator — many operators bill permits as 'extras' at drop." },
            { question: "Which vehicle is best for this 9-hour drive?", answer: "For 2-3 passengers: Sedan ₹7,980 (most economical). For 4-7 passengers with luggage: SUV ₹10,830 or Innova ₹11,400. For elderly travellers or VIP corporate trips: Innova Crysta ₹12,540 — captain seats variant, quieter cabin, smoother suspension matter on the long Anantapur straight. For 10+ groups: Tempo Traveller (call for quote)." },
            { question: "Is the overnight slot (10 PM departure) safe?", answer: "Yes — this is our most-booked slot on this route. NH44 is a major commercial corridor with heavy 24/7 truck traffic, well-lit through major sections, and fuel/dhaba availability throughout. We assign senior drivers with NH44 night experience. Night charges (₹250-500) apply for trips between 10 PM and 6 AM. Crysta or Innova recommended for the overnight slot — smoother ride helps passengers sleep." },
            { question: "Can the taxi drop at KIA airport (Bangalore) directly?", answer: "Yes — KIA direct drop is one of the most-booked patterns. The airport is at Devanahalli, 35 km north of central Bangalore. Hyderabad → KIA direct saves 60-90 min vs continuing to the city core; it's ~₹500 less than the full city drop. Common for passengers with onward international/domestic flights from KIA." },
            { question: "Can I stop at Puttaparthi Sai Baba Ashram on the way?", answer: "Yes — Puttaparthi is 95 km off NH44 at Anantapur. The 190 km round-trip detour adds 3-4 hours to the journey and ₹2,000-2,500 to the fare (per-km × detour distance). Common pattern: Hyderabad → Puttaparthi (5 hours) → ashram visit (4-6 hours) → continue to Bangalore (5 hours). Best done as a 2-day package with a Puttaparthi overnight halt." },
            { question: "Do you offer corporate weekly transfer accounts?", answer: "Yes — Monday Hyderabad → Bangalore IT corridor + Friday return is a dedicated booking pattern. We assign a consistent driver for the account, run monthly consolidated GST-invoice billing, and offer ~5-8% volume discount for 4+ trips/week. Popular with HITEC City and Madhapur IT companies with Bangalore operations." },
            { question: "Is one-way taxi cheaper than flight + local taxi for Hyderabad-Bangalore?", answer: "Depends on group size and luggage. For 1 passenger with hand luggage, a flight (~₹3,500-5,500 economy) + ₹800 local taxi at Bangalore can be cheaper than a ₹7,980 sedan. For 3+ passengers with luggage, the taxi (₹7,980 sedan or ₹10,830 SUV) is significantly cheaper than 3 flight tickets + airport transfers. Corporate travellers also prefer the taxi for productive cabin time (calls, laptop work) on the 9-hour drive, plus door-to-door convenience eliminating airport security, baggage, and traffic uncertainty." },
        ],
    },
    "coimbatore-to-ooty": {
        snippetLede:
