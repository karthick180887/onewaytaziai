...
export const metadata: Metadata = {
  ...
  description: "Book one-way drop taxis across South India — Chennai, Bangalore, Coimbatore & 220+ cities. Starting ₹13/km. Save 40%. 24/7 verified drivers.",
  ...
  openGraph: {
    ...
    description: "Book affordable one-way drop taxis across South India. Pay only for one way — starting ₹13/km. 220+ cities, 24/7 service, verified drivers.",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: "South India's leading one-way drop taxi service covering 220+ cities across Tamil Nadu, Kerala, Karnataka, Andhra Pradesh, Telangana, and Pondicherry.",
